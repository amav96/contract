...
?>
<?php require_once('../../vistas/include/admin_update/superior_administracion.php') ?>
      ...
      <div class="table-title" style="position:inherit;">
        <div class="row" style="position:inherit;color:black;">
          <div class="col-sm-6" style="position:inherit;">
            <b><h2>Panel Administración</b></h2>
          </div>
          ...
          <div class="form-group">
                 <input type="text" class="form-control" name="id_admin" id="id_admin" value="<?php if(isset($_SESSION['usuario']))
							    { echo $_SESSION['usuario']['usuario']; } ?>" placeholder="ID recolector" style="width:100px;height:25px;" >
  ...
  <?php //include("../../html/modal_add.php");?>
	<!-- Edit Modal HTML -->
	<?php include("../../html/adm/modal_edit.php");?>
	<!-- Delete Modal HTML -->
	<?php //include("../../html/modal_delete.php");?>

<!-- cerrar sesion despues de cierto tiempo-->
<?php require_once('../../vistas/include/admin_update/inferior_administracion.php')  ?>


	<script src="../../script/administracion/script.js"></script>
