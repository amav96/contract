            ...
            if(($result->num_rows>0) && ($result->num_rows<2))
            {
                ...
                $row= $result->fetch_array();
                 ...
                 if($tipo==='PM'){ 
                         ...
                         $jsonEncodeSoloPM=json_encode($jsonOpcionesSoloPM); echo $jsonEncodeSoloPM;}
                 ...
                 if(($tipo !=='PM') && ($tipo !=='RECOLECTOR') && ($tipo !== 'COMERCIO')){ 
                     ...
                     $jsonEncodeNada=json_encode($jsonOpcionesNada); echo $jsonEncodeNada;}
                        ...
                        //    SI HAY MAS DE UNA OPCIÓN PARA RECUPERAR!!!
...
if($result){
    $objeto[] = array(); $objeto = array('result' => 1,);
        ...
        //    aviso de gestionado
           ...
           $queryUpdate="UPDATE express set estado_gestion='auto-recolector' where identificacion='$identificacionClean'";
